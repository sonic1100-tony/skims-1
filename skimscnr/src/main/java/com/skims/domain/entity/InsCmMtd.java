...
//    @Schema(description = "", nullable = true , defaultValue = "" , example = ""  , allowableValues = {"", ""})
    ...
    @Builder
    public InsCmMtd(String plyno, Date apNddt, Date apStrdt, String ndsno, String valdNdsYn, Timestamp ndsApStrDthms, Timestamp ndsApNdDthms, String cmMtdcd, String slrTfStfno, String crtSlrtfStfRelcd, String autoTfRqdcSsno, String inpUsrId, Timestamp inpDthms, String mdfUsrId, Timestamp mdfDthms) {
        this.plyno = plyno;
        this.apNddt = apNddt;
