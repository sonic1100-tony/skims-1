...
//    @Schema(description = "", nullable = true , defaultValue = "" , example = ""  , allowableValues = {"", ""})
    ...
    @Builder
    public InsCrCvr(String plyno, String cvrcd, BigDecimal cvrSeqno, LocalDate apNddt, LocalDate apStrdt, String ndsno, String valdNdsYn, LocalDateTime ndsApStrDthms, LocalDateTime ndsApNdDthms, String ikdGrpcd, String cvrBjFlgcd, BigDecimal relpcOjSeqno, BigDecimal relpcSeqno, String cvrBaTrtFlgcd, String cvrSuboLvlFlgcd, String cvrStcd, LocalDate cvrStChdt, BigDecimal isamt, BigDecimal ndsIsamt, BigDecimal baPrm, BigDecimal ndsBaPrm, BigDecimal apPrm, BigDecimal ndsApPrm, BigDecimal scdInsTrmApprm, LocalDate insSt, String insStHms, LocalDate insClstr, String insClstrHms, String selfChamtMncd, BigDecimal selfChamt, String agmtAqrRtFlgcd, String nrdpsLvlcd, String rkTpcd, String rnwTpcd, BigDecimal chbfApPrm, BigDecimal chafApPrm, BigDecimal dscrt, BigDecimal dcbfPrm, BigDecimal nrdpsDcamt, BigDecimal sccKdsSpcDcamt, String pymCyccd, String pymTrmcd, String cvrStStYymm, String pymXmpYn, String pymXmpStrYymm, LocalDate rfamtClcInsSt, LocalDate rfamtClcInsClstr, String autoRnwAvYn, LocalDate autoRnwCvrCnldt, String cvrFnlPymYymm, BigDecimal cvrFnlPymSeq, String ndFlgcd, BigDecimal nd, String ndcd, BigDecimal rlNdTrm, String pymTrmFlgcd, BigDecimal pymTrm, BigDecimal rlPymTrm, BigDecimal nrdpsApAge, BigDecimal bfrnwCvrsn, String bfrnwCvrcd, BigDecimal trtPregRndWkct, String dbCvrFlgcd, String cvrIsTpcd, String afgstPrmCcbjYn, String sepCrCnYn, String flpyCvrfsSbYn, LocalDate rnwNddt, BigDecimal rnwCvrNclmDcamt, BigDecimal rwcvrNclmAdDcamt, BigDecimal sustdXcRkNdx, BigDecimal stdbdPrm, BigDecimal sustdPrm, BigDecimal dcamt, BigDecimal sustdRwcvrNclmDcamt, BigDecimal stdbdRwcvrNclmDcamt, String clmrlNdsApcd, BigDecimal rmimcStbzDcamt, String cvrXtnStcd, String sbCscd, String isamtCd, BigDecimal xpDmamt, BigDecimal mdDmamt, BigDecimal trtApCvrPrmsm, LocalDate sysMpvDt, String trtApCvrcd, String mstrCarPlyno, String clmp1IsAmtcd, String emegMvoCeStfno, LocalDate emegMvoCnrdt, String cvrSpquFlgcd, LocalDate ndsPrdt, BigDecimal xpSumAmt, BigDecimal mdSumAmt, String deSelObsFlgcd, String itmCvrRkRnk, String imuTrmcd, BigDecimal agrRt, String abscTrmFlgcd, String agrRestTrmcd, String isamtSpc, BigDecimal esrct, String bdDlbrRpblBtpcd, BigDecimal woncrCvSelfChamt, BigDecimal dcRt, BigDecimal actOrActct, String frcRtApYn, BigDecimal adSelfChamt, String prgcsPrtYn, String rtKeyAssmbCd, String bzcsRtKeyAssmbCd, LocalDate prmApStrdt, LocalDate prmApNddt, String slCvrcd, BigDecimal slCvrsn, String cmpLmcd, String inpUsrId, LocalDateTime inpDthms, String mdfUsrId, LocalDateTime mdfDthms) {
        this.plyno = plyno;
        this.cvrcd = cvrcd;
