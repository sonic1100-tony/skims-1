...
public class InsAutoTfRq implements Serializable {
    ...
    @Builder
    public InsAutoTfRq(String plynoOrLnno, String autoTfCgKndcd, LocalDate apNddt, LocalDate apStrdt, String ndsno,
            BigDecimal olcrrSeqno, String valdNdsYn, LocalDateTime ndsApStrDthms, LocalDateTime ndsApNdDthms,
            String ctmno, String bkOrCrdCmpcd, String actnoOrCrdno, String epayPeriStmNo, String tfTpcd, String bkBrcd,
            String bkBrnm, String crdValdTrm, String tfRqFlgcd, String dpsrOrCrdOwrnm, String ctmDscno, String crtRelcd,
            String ntTfHpdyCd, String tfDlMetcd, String autoTfRqPtncd, String ptcrdSsYn, LocalDate rqRqudt,
            String tfRqDlStcd, LocalDate rqRstRcpdt, String bdlTfYn, String bncRmactSynchYn, String chCrdno,
            String chCrdValdTrm, String tfRqVncErcd, String tfRqWdcmpErcd, BigDecimal atMntct, String tfErFlgcd,
            LocalDate rqdt, LocalDate cnldt, LocalDate cnRqudt, String tfCnDlStcd, String lnPlyno, String frcCrtYn,
            String autoTfRqdcSsno, String dpsrTlno, String dhCmpcd, String fbsCvYn, LocalDate ctmRqdt,
            String evdDaFlgcd, String evdDaDscVl, String evdDaSavePtncd, String rlPyrNo, String vocNo,
            String vocHdcftRgtYn, String epayFlgcd, String inpUsrId, LocalDateTime inpDthms, String mdfUsrId,
