...
//    @Schema(description = "", nullable = true , defaultValue = "" , example = ""  , allowableValues = {"", ""})
    ...
    @Builder
    public InsTfErcd(String tfDlMetcd, String wdcmpOrVnccd, String tfRqDmFlgcd, String tfRqErcd, String erCn, String actErDlbjYn, String erDtCn, String inpUsrId, LocalDateTime inpDthms, String mdfUsrId, LocalDateTime mdfDthms) {
