...
public class InsIncmPrm implements Serializable {
    ...
    @Builder
    public InsIncmPrm(String plyno, BigDecimal incmPrmCrSeqno, BigDecimal pymSeq, String ndsno, String fnlPymYymm,
            BigDecimal pypTSeq, BigDecimal rpPrm, BigDecimal apPrm, String dpCascd, String dpDtCascd, String rvSbno,
            LocalDate ccldt, String cclFlgcd, LocalDate ppdt, String pymCyccd, String dhStfno, String usrno,
            String rpAdmno, String mncd, BigDecimal fcApPrm, BigDecimal usdCvApPrm, String xcrtFlgcd,
            BigDecimal fcApXcrt, BigDecimal usdApXcrt, BigDecimal fcCondtTPrm, BigDecimal condtTPrm, String udrtkTycd,
            String otcmMgCmpcd, BigDecimal cnnIncmPrmcrSeqno, String hscsHsFlgcd, BigDecimal pypAdCs,
            BigDecimal baCvrPrm, BigDecimal trtPrm, BigDecimal cuPrm, BigDecimal flpyCvrTrtPrm, BigDecimal dcbfCuPrm,
            BigDecimal cuNprm, String ppyYn, String ppyDcYn, String nwfsqFlgcd, String autoTfDcYn, BigDecimal rviNt,
            String duArFlgcd, String prmDissYn, String cvrPrmDisbjYn, BigDecimal dcbfPrm, String sbFlgcd,
            String ondsDpTpcd, String rtnFlgcd, String prmFlgcd, LocalDate prmEfctNddt, String bkcd, String bkBrcd,
            String bkExtnQfp, String bkIpps, String bncAdmr, LocalDate pymDudt, String dblPaymYn, String acTfYn,
            String ucPrmYn, String coCrtRvFlgcd, String ikdGrpcd, BigDecimal cclWdrRtnNt, String payaoYn,
            String amtNdscd, BigDecimal crtRelpcSeqno, BigDecimal tincmPrmCrSeqno, String pynoWhpyBjno, String coCrtYn,
            LocalDate cuStRpdt, String selfCrYn, String rdchCrYn, LocalDate rvDldt, String logorTpcd,
            BigDecimal adpymBeloMwWlamt, BigDecimal pfPrm, String npAccLdgno, String inpUsrId, LocalDateTime inpDthms,
