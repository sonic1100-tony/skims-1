...
public class InsDpDlEr implements Serializable {
    ...
    @Builder
    public InsDpDlEr(BigDecimal dpDlErSeqno, String plyno, BigDecimal pymSeq, String dpCascd, String dpDtCascd,
            String rtxKndcd, String dpRstErcd, String fnlPymYymm, String pymCyccd, String pymMtdcd, LocalDate rpdt,
            BigDecimal rviNt, BigDecimal ptyOrRtnPrm, BigDecimal apPrm, BigDecimal rpamt, String dhStfno,
            String dppsFlgcd, String rvDlRstcd, String ctmInqAutoTfsno, LocalDate pvlPrdt, String ikdGrpcd,
            String rvSbno, String frDpRstErcd, String inpUsrId, LocalDateTime inpDthms, String mdfUsrId,
