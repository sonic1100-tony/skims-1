...
public class InsWhpyRq implements Serializable {
    ...
    @Builder
    public InsWhpyRq(LocalDate whpyRqdt, BigDecimal ssno, BigDecimal ssDtno, String crtRsno, String crtName,
            String plyno, LocalDate ssdt, String rqorCd, String whpyRqDlStcd, String rqValdYn, BigDecimal oldssNo,
            String frcRqYn, String pyDlStcd, String pyRcpMtdcd, String pyMtdcd, String pfbRcpsRelcd, String rqapsRsno,
            String rqapsNm, String dlgPyRscd, String pyBjnm, String pyBjRsBzmno, String actno, String bkcd,
            String dpsrRsBzmno, String dpsnm, String pyBjDpsrRelcd, String rcapmOrgcd, String cnvYn, String cnvpsNm,
            BigDecimal rqamt, BigDecimal uiamt, BigDecimal sbPyamt, String rsvDlRstErcd, String claLnApYn,
            String lnFdUsecd, String clnrfBkcd, String clnrfActno, String clnrfDpsrRsBzmno, String clnrfDpsnm,
            String clnrfTfHpdyCd, String clnrfCrtRelcd, String pyCrTpcd, String pyRsCascd, String pyRsMdccd,
            String pyRsSmccd, String anTfactTpcd, String anTfactIsdyFlgcd, String evdDaFlgcd, String evdDaDscVl,
            String evdDaSavePtncd, String autoPyFlgcd, BigDecimal pyNt, String rlDpsnm, String befoChekRstcd,
            String dlOrgAnscd, String dpsrInqAnscd, LocalDate pyRsCrdt, LocalDate cmpRcgntDt, String inpUsrId,
