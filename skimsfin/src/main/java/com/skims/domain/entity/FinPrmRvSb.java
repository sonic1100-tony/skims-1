...
public class FinPrmRvSb implements Serializable {
    ...
    @Builder
    public FinPrmRvSb(String rvSbno, String crSyscd, String dlTpO1Csfcd, String dlTpO2Csfcd, LocalDate rpdt,
            String dhOrgcd, String dhStfno, String ikdGrpcd, String insImcd, String invlnGdcd, String ntaccCd,
            LocalDate cnrdt, String plyno, BigDecimal incmPrmCrSeqno, String ndsno, String ctmno, String crtRsno,
            LocalDate rpblOpndt, String ltrmCrTotno, String udrtkTycd, String dpCascd, String mntFlgcd, LocalDate dpdt,
            String rpAdmno, String plno, String bsnsNdsFlgcd, String clsafYn, String totFlgcd, BigDecimal totct,
            BigDecimal totPrm, BigDecimal woncrPrm, BigDecimal crRnPrm, BigDecimal crDtamt, String mncd,
            BigDecimal fcPrm, BigDecimal apXcrt, BigDecimal tfCm, String etamtFlgcd, BigDecimal etamt, LocalDate rvdt,
            String rvOrgcd, String rvXcno, String daCrTpcd, String girAttfErYn, String girDpStcd, LocalDate prmPvlSlpdt,
            String prmPvlSlpno, String prmPvlSlpLnno, LocalDate ppdt, String ucPrmYn, String msgId, String msgTpCsfcd,
            LocalDate tlmTsdt, String tlmPno, String tlmSpecd, String spbzFlgcd, String actno, String dpsnm,
            String crrnm, String inrIkdGrpcd, String inrPlyno, BigDecimal inrPrm, String bkcd, String crdCmpcd,
            String cclYn, String dhCmpcd, String crdSmamtAryn, String rvDlFlgcd, LocalDate inrEdamtDldt,
            String inrRtxno, String finaDatVrfFlg1Vl, String finaDatVrfFlg2Vl, String finaDatVrfFlg3Vl,
            String agrEntpYn, BigDecimal crRpblPrm, String inpUsrId, LocalDateTime inpDthms, String mdfUsrId,
