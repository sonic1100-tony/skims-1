...
//    @Schema(description = "", nullable = true , defaultValue = "" , example = ""  , allowableValues = {"", ""})
    ...
    @Builder
    public CusPstpoRcpl(String ctmno, LocalDateTime apNdDthms, LocalDateTime apStrDthms, String pstpoRcplFlgcd, String chDlno, String inpUsrId, LocalDateTime inpDthms, String mdfUsrId, LocalDateTime mdfDthms) {
        this.ctmno = ctmno;
