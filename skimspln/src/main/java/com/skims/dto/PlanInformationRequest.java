...
public class PlanInformationRequest implements Serializable {
     ...
     * 보험설계
     */
    private PlanInformationDto.InsurancePlan insurancePlan;

    /**
     * 피보험자
     */
    private List<PlanInformationDto.InsuredPerson> insuredPersons;
    ...
    public static class InsuredPerson {
        ...
        /** 담보 */
        private List<PlanInformationDto.Coverage> coverages;
    }
