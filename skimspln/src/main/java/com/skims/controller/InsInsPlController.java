                ...
                .map(oldData -> {
                    newMap.forEach((strKey, strValue) -> {
						switch(strKey){
						    ...
						    case "pldt" : oldData.setPldt(newData.getPldt()); break;
						    case "valdPlYn" : oldData.setValdPlYn(newData.getValdPlYn()); break;
						    case "plFlgcd" : oldData.setPlFlgcd(newData.getPlFlgcd()); break;
						    case "cmMtdcd" : oldData.setCmMtdcd(newData.getCmMtdcd()); break;
						    case "plStcd" : oldData.setPlStcd(newData.getPlStcd()); break;
						    case "plStChdt" : oldData.setPlStChdt(newData.getPlStChdt()); break;
						    case "fstiDmMtdcd" : oldData.setFstiDmMtdcd(newData.getFstiDmMtdcd()); break;
						    case "isPlKndcd" : oldData.setIsPlKndcd(newData.getIsPlKndcd()); break;
						    case "xpDmgrt" : oldData.setXpDmgrt(newData.getXpDmgrt()); break;
						    case "plCmprGpno" : oldData.setPlCmprGpno(newData.getPlCmprGpno()); break;
						    case "recPlno" : oldData.setRecPlno(newData.getRecPlno()); break;
						    case "recCgaocSeqno" : oldData.setRecCgaocSeqno(newData.getRecCgaocSeqno()); break;
						    case "recCorcd" : oldData.setRecCorcd(newData.getRecCorcd()); break;
						    case "plValdPerdt" : oldData.setPlValdPerdt(newData.getPlValdPerdt()); break;
						    case "spccfPlno" : oldData.setSpccfPlno(newData.getSpccfPlno()); break;
						    case "spccfCgafChSeqno" : oldData.setSpccfCgafChSeqno(newData.getSpccfCgafChSeqno()); break;
						    case "ndPlTpcd" : oldData.setNdPlTpcd(newData.getNdPlTpcd()); break;
						    case "udrtkGuVltYn" : oldData.setUdrtkGuVltYn(newData.getUdrtkGuVltYn()); break;
						    case "plChPsbdt" : oldData.setPlChPsbdt(newData.getPlChPsbdt()); break;
						    case "dgnBjYn" : oldData.setDgnBjYn(newData.getDgnBjYn()); break;
						    case "rqRcpno" : oldData.setRqRcpno(newData.getRqRcpno()); break;
						    case "plyno" : oldData.setPlyno(newData.getPlyno()); break;
						    case "cnrdt" : oldData.setCnrdt(newData.getCnrdt()); break;
						    case "pprPlno" : oldData.setPprPlno(newData.getPprPlno()); break;
						    case "pprCgaocSeqno" : oldData.setPprCgaocSeqno(newData.getPprCgaocSeqno()); break;
						    ...
						    case "rviPlno" : oldData.setRviPlno(newData.getRviPlno()); break;
						    case "isPlTycd" : oldData.setIsPlTycd(newData.getIsPlTycd()); break;
						    case "qaUdBjyn" : oldData.setQaUdBjyn(newData.getQaUdBjyn()); break;
						    case "rvibaNdsDlFlgcd" : oldData.setRvibaNdsDlFlgcd(newData.getRvibaNdsDlFlgcd()); break;
						    ...
						    case "plCt" : oldData.setPlCt(newData.getPlCt()); break;
						    case "dcApPlCt" : oldData.setDcApPlCt(newData.getDcApPlCt()); break;
						    case "grRvSbStcd" : oldData.setGrRvSbStcd(newData.getGrRvSbStcd()); break;
						    ...
						    case "mwWlamt" : oldData.setMwWlamt(newData.getMwWlamt()); break;
						    case "frMwwdrRndYyct" : oldData.setFrMwwdrRndYyct(newData.getFrMwwdrRndYyct()); break;
						    case "mwWdraSt" : oldData.setMwWdraSt(newData.getMwWdraSt()); break;
						    ...
						    case "plStDtcd" : oldData.setPlStDtcd(newData.getPlStDtcd()); break;
						    case "udAsTpcd" : oldData.setUdAsTpcd(newData.getUdAsTpcd()); break;
						    case "befoCgaocSeqno" : oldData.setBefoCgaocSeqno(newData.getBefoCgaocSeqno()); break;
						    case "befoPlno" : oldData.setBefoPlno(newData.getBefoPlno()); break;
						    case "guPlyno" : oldData.setGuPlyno(newData.getGuPlyno()); break;
						    case "prnotTrnmMtdcd" : oldData.setPrnotTrnmMtdcd(newData.getPrnotTrnmMtdcd()); break;
						    case "plRcpTpcd" : oldData.setPlRcpTpcd(newData.getPlRcpTpcd()); break;
						    case "plRcpno" : oldData.setPlRcpno(newData.getPlRcpno()); break;
						    case "smsSndYn" : oldData.setSmsSndYn(newData.getSmsSndYn()); break;
						    case "ltranPlno" : oldData.setLtranPlno(newData.getLtranPlno()); break;
						    case "ltranCgafChSeqno" : oldData.setLtranCgafChSeqno(newData.getLtranCgafChSeqno()); break;
