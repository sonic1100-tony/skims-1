...
public interface InsPlRelpcRepository extends JpaRepository<InsPlRelpc, Long> {
	List<InsPlRelpc> findByPlnoAndCgafChSeqnoAndRelpcTpcd(String plno, BigDecimal cgafChSeqno, String relpcTpcd);
}
