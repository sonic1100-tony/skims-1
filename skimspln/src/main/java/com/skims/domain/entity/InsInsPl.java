...
public class InsInsPl implements Serializable {
    ...
    @Builder
    public InsInsPl(String plno, BigDecimal cgafChSeqno, LocalDate pldt, String valdPlYn, String cmMtdcd, String plStcd,
            LocalDate plStChdt, BigDecimal xpDmgrt, String plyno, LocalDate cnrdt, String fnlCrStcd, String fnlCrDtStcd,
            String fnlPartCvrStcd, LocalDate fnlCrStChdt, BigDecimal fnlPymSeq, String fnlPymYymm, String plyLvlFlgcd,
            String gdcd, String ikdGrpcd, LocalDate apldt, String trmSctFlgcd, LocalDate insSt, LocalDate insClstr,
            BigDecimal insDays, BigDecimal instrMc, BigDecimal bfcrAprt, BigDecimal fstiRpPrm, BigDecimal dpsrt,
            BigDecimal fcntrDmgrt, BigDecimal dmgrtMdCfc, String pymTrmFlgcd, BigDecimal pymTrm, String pymTrmcd,
            BigDecimal rlPymTrm, String ndFlgcd, BigDecimal nd, String ndcd, BigDecimal rlNdTrm, String pymCyccd,
            BigDecimal mwWlamt, BigDecimal rviNt, BigDecimal anPyGirt, BigDecimal txPfamt, BigDecimal grDscrt,
            BigDecimal baPrm, BigDecimal apPrm, String dhStfno, String inpUsrId, LocalDateTime inpDthms,
