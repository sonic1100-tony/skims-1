...
import com.skims.domain.listener.InsPlNrdpsTisrdAtrListener;

@Data
@NoArgsConstructor(access = AccessLevel.PROTECTED) // AccessLevel.PUBLIC
@Entity
@EntityListeners(InsPlNrdpsTisrdAtrListener.class)
...
public class InsPlNrdpsTisrdAtr implements Serializable {
    ...
    @Builder
    public InsPlNrdpsTisrdAtr(String plno, BigDecimal cgafChSeqno, BigDecimal relpcSeqno, String ikdGrpcd,
            String nrdpsTisrdFlgcd, String plPlcd, String plCsfcd, String mdNrdpsFlgcd, String gpIsTp,
            BigDecimal nrdpsOrTisct, BigDecimal fmlct, BigDecimal manPsct, BigDecimal fmlPsct, String rxamBjYn,
            String twhvcDrveYn, String drveYn, LocalDate insSt, String insStHms, LocalDate insClstr, String insClstrHms,
            LocalDate rfdClcSt, LocalDate rfdClcClstr, String drveTycd, String brth, String embrYn, String sexcd,
            BigDecimal age, String jbcd, BigDecimal jbChSeqno, String injrRnkcd, String trfRnkcd, String injrGrdcd,
            String ptn, String bdt, LocalDate bthdt, LocalDate stbdt, BigDecimal pregRndwk, String mdcsRgtFlgcd,
            String mdcsRgtStcd, String sttPfsstFlgcd, String bkcd, LocalDate tisrdRcpdt, LocalDate acdisRgtdt,
            String drveLicSpecd, String paMncd, BigDecimal mnthAvgPa, BigDecimal yearPaTamt, String xcApYn,
            String brdpsRvpsFlgcd, String dtycd, String rcnBjyn, String dgnUdBjYn, BigDecimal adIrtApChdct,
            String embrIsAvYn, LocalDate bthPrdt, String nwbbyNm, String nwbbyRsno, LocalDate pregRndwkStdt,
            String mdcsInqAgreYn, String smokYn, BigDecimal dscrt, String rvibaNdsNeedYn, String ltrmNdsDlFlgcd,
            String wpcnm, String bnnm, String cePlcd, String xclcBdYn, String unfRtApYn, String twhvcSubCvrtrIsFlgcd,
            BigDecimal dcAge, String hltAgePrmApTrtIsFlgcd, String hltAgeDcApFlgcd, String inpUsrId,
