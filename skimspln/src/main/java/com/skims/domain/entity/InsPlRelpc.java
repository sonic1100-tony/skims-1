...
import com.skims.domain.listener.InsPlRelpcListener;

@Data
@NoArgsConstructor(access = AccessLevel.PROTECTED) // AccessLevel.PUBLIC
@Entity
@EntityListeners(InsPlRelpcListener.class)
@Table(name = "ins_pl_relpc") // --설계관계자
...
public class InsPlRelpc implements Serializable {
    ...
    @Builder
    public InsPlRelpc(String plno, BigDecimal cgafChSeqno, BigDecimal relpcSeqno, String ikdGrpcd, String relpcTpcd,
            String relpcStcd, LocalDate stChdt, String hnglRelnm, String engRelnm, String ctmDscno,
            String relpcDscnoFlgcd, String dlncd, String prsRelpcYn, BigDecimal cntadSeqno, String cntadFlgcd,
            String relpcName, String relpcNamePstcd, String relpcRlecd, LocalDate isrdt, BigDecimal pprRelpcSeqno,
            String ctmno, String sbdGrCtmno, String guPlyno, String orelCd, String subCtmDscno, String fireMnNrdpsYn,
            String injrHspCvrYn, String injrOtpCvrYn, String dsasHspCvrYn, String dsasOtpCvrYn, String gnrzHspCvrYn,
            String gnrzOtpCvrYn, String sepCrCnYn, String rntcrYn, String fnOrgcd, String prpsFlgcd,
            BigDecimal prmPymRt, String hndpsYn, String ntnMrtmnYn, String baSadpsYn, String crtFlgcd, String dmosFlgcd,
            String indpdMrtmnYn, String dfltPtYn, String dmrcy518InjdYn, String ndtmRisAgreYn, String pfbFlgcd,
            String nrdpsAgreYn, BigDecimal utRt, String mdCfcapEntpYn, String sexcd, String jbcd, BigDecimal jbChSeqno,
            BigDecimal age, String wdgYn, String licSpecd, String licno, LocalDate licCqdt, String clmCrrYn,
            BigDecimal drveCrrYyct, BigDecimal drveCrrMntct, String drvFlgcd, LocalDate hotStdt, LocalDate hotClsdt,
            String hotOj, String ltrmNdsDlFlgcd, String relpcScrInpYn, String idntyCnfcKndcd, String idntyCnfcEtInfo,
            String idntyCnfcNo, LocalDate idntyCnfcIsdt, String idntyCnfcIsOrgnm, String idntyCnfPdtnm,
            String idntyCnfBnnm, String rdchCrTpcd, String crUdrtkArecd, String pectSlMntrChncd, String mailRcvYn,
            String cmMnUsCnAgryn, String pfbAstchAgrYn, String pfbAstchRscd, LocalDate isCrrApprStrdt,
            LocalDate isCrrApprNddt, String mdSlrSadpsYn, String fdWshBjGrdcd, String ovsePytxDtyTpcd, String inpUsrId,
