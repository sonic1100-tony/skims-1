--
-- Table structure for table `b1_220411_igd_ltrm_rfd`
--

DROP TABLE IF EXISTS `b1_220411_igd_ltrm_rfd`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `b1_220411_igd_ltrm_rfd` (
...
) ENGINE=InnoDB AUTO_INCREMENT=702531 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='장기준비금';
