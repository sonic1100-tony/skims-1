--
-- Table structure for table `b1_211102_cmp_cvap_dl_crr`
--

DROP TABLE IF EXISTS `b1_211102_cmp_cvap_dl_crr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `b1_211102_cmp_cvap_dl_crr` (
  ...
  PRIMARY KEY (`cvap_aid`,`cvap_dl_crr_seqno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='민원처리이력';
