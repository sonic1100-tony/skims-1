--
-- Table structure for table `cmp_slfrgl_vltb`
--

DROP TABLE IF EXISTS `cmp_slfrgl_vltb`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cmp_slfrgl_vltb` (
  ...
  `half_flgcd` varchar(10) COLLATE utf8mb4_bin NOT NULL COMMENT '반기구분코드',
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_cmp_slfrgl_vltb_00` (`vl_chk_bsns_flgcd`,`o1_vl_chk_csfvl`,`chk_yymm`,`half_flgcd`,`chk_orgcd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='자율규제평가표';
