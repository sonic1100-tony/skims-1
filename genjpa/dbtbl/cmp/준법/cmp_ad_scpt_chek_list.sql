--
-- Table structure for table `cmp_ad_scpt_chek_list`
--

DROP TABLE IF EXISTS `cmp_ad_scpt_chek_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cmp_ad_scpt_chek_list` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='광고스크립트체크리스트';
