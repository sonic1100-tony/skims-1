--
-- Table structure for table `cmp_cvap_adm`
--

DROP TABLE IF EXISTS `cmp_cvap_adm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cmp_cvap_adm` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `idx_cmp_cvap_adm_00` (`cvap_rcpno`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='민원관리';
