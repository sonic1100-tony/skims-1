--
-- Table structure for table `cmp_cvap_relcc`
--

DROP TABLE IF EXISTS `cmp_cvap_relcc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cmp_cvap_relcc` (
  ...
  UNIQUE KEY `idx_cmp_cvap_relcc_00` (`cvap_rcpno`,`cvam_tpcd`),
  KEY `idx_cmp_cvap_relcc_10` (`cvam_ctmdn1`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='민원관련자';
