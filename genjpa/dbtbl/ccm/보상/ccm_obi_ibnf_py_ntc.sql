--
-- Table structure for table `ccm_obi_ibnf_py_ntc`
--

DROP TABLE IF EXISTS `ccm_obi_ibnf_py_ntc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ccm_obi_ibnf_py_ntc` (
  ...
  `obi_clm_rcp_yn` varchar(1) COLLATE utf8mb4_bin NOT NULL COMMENT '자손사고접수여부',
  `py_ntc_bjps_flgcd` varchar(10) COLLATE utf8mb4_bin NOT NULL COMMENT '지급안내대상자구분코드',
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ccm_obi_ibnf_py_ntc_00` (`rcp_yymm`,`rcp_nv_seqno`,`ntc_seqno`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='자손보험금지급안내';
