--
-- Table structure for table `ccm_lse_dt_py_rs_info`
--

DROP TABLE IF EXISTS `ccm_lse_dt_py_rs_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ccm_lse_dt_py_rs_info` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ccm_lse_dt_py_rs_info_00` (`stdt`,`crdis_bsns_flgcd`,`crdis_sno`,`clm_sno`,`dm_sno`,`crdis_ins_knd_flgcd`,`plyno`,`victm_gd_sno`,`py_rscd`,`pydt`,`dt_py_rscd`,`dt_py_sno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='보험신용정보_상세지급사유정보';
