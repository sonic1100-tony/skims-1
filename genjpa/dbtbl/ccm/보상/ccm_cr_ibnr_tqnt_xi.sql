--
-- Table structure for table `ccm_cr_ibnr_tqnt_xi`
--

DROP TABLE IF EXISTS `ccm_cr_ibnr_tqnt_xi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ccm_cr_ibnr_tqnt_xi` (
  `aid` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'AID',
  `cc_st_yymm` varchar(6) COLLATE utf8mb4_bin NOT NULL COMMENT '산출기준년월',
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ccm_cr_ibnr_tqnt_xi_00` (`cc_st_yymm`,`ibnr_cr_cvr_flgcd`,`ibnr_injr_flgcd`,`ibnr_cls_flgcd`,`ibnr_cc_cyccd`,`sts_trmcd`,`ibnr_avg_flgcd`,`ibnr_wgt_rt`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='자동차IBNR총량추산';
