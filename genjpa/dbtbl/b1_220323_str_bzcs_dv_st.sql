--
-- Table structure for table `b1_220323_str_bzcs_dv_st`
--

DROP TABLE IF EXISTS `b1_220323_str_bzcs_dv_st`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `b1_220323_str_bzcs_dv_st` (
  ...
  UNIQUE KEY `pux_str_bzcs_dv_st_00` (`st_yymm`,`orgcd`,`bzcs_dvcd`,`ins_imcd`,`sl_tpcd`,`cvrcd`,`ins_imcd_lvl`)
) ENGINE=InnoDB AUTO_INCREMENT=208406 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='사업비배분기준'
