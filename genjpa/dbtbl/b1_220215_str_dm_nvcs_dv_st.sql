--
-- Table structure for table `b1_220215_str_dm_nvcs_dv_st`
--

DROP TABLE IF EXISTS `b1_220215_str_dm_nvcs_dv_st`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `b1_220215_str_dm_nvcs_dv_st` (
  ...
  PRIMARY KEY (`st_yymm`,`orgcd`,`bzcs_dvcd`,`ins_imcd`,`sl_tpcd`,`cvrcd`)
