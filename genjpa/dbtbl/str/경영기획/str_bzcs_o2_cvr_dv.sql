--
-- Table structure for table `str_bzcs_o2_cvr_dv`
--

DROP TABLE IF EXISTS `str_bzcs_o2_cvr_dv`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `str_bzcs_o2_cvr_dv` (
  ...
  UNIQUE KEY `pux_str_bzcs_o2_cvr_dv_00` (`slpdt`,`slpno`,`slp_lnno`,`sno`,`rr_orgcd`,`bzcs_tpcd`,`ins_imcd`,`gdcd`,`sl_tpcd`,`sub_sno`,`cvrcd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='사업비2차담보배분'
