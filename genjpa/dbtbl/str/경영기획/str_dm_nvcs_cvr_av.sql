--
-- Table structure for table `str_dm_nvcs_cvr_av`
--

DROP TABLE IF EXISTS `str_dm_nvcs_cvr_av`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `str_dm_nvcs_cvr_av` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_str_dm_nvcs_cvr_av_00` (`st_yymm`,`orgcd`,`ins_imcd`,`gdcd`,`sl_tpcd`,`cvrcd`)
) ENGINE=InnoDB AUTO_INCREMENT=845 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='손해조사비담보실적';
