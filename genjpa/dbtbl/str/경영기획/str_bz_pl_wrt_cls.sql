--
-- Table structure for table `str_bz_pl_wrt_cls`
--

DROP TABLE IF EXISTS `str_bz_pl_wrt_cls`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `str_bz_pl_wrt_cls` (
  ...
  PRIMARY KEY (`cy_yr`,`bz_plcd`,`bz_pl_orgcd`,`bz_pl_ins_imcd`,`as_orgcd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='사업계획작성마감';
