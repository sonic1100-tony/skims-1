--
-- Table structure for table `str_bzcs_o1_dv`
--

DROP TABLE IF EXISTS `str_bzcs_o1_dv`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `str_bzcs_o1_dv` (
  ...
  UNIQUE KEY `pux_str_bzcs_o1_dv_00` (`slpdt`,`slpno`,`slp_lnno`,`sno`,`rr_orgcd`,`bzcs_tpcd`)
) ENGINE=InnoDB AUTO_INCREMENT=534 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='사업비1차배분'
