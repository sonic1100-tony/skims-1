--
-- Table structure for table `str_cscl_rcv_rtn_py_spc`
--

DROP TABLE IF EXISTS `str_cscl_rcv_rtn_py_spc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `str_cscl_rcv_rtn_py_spc` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_str_cscl_rcv_rtn_py_spc_00` (`plyno`,`rcv_cls_yymm`,`rcv_mtdcd`,`prpn_aw_flgcd`,`aw_ben_stfno`,`aw_cr_seqno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='건별수당환수환급지급내역';
