--
-- Table structure for table `str_17_bzcs_slp_spc`
--

DROP TABLE IF EXISTS `str_17_bzcs_slp_spc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `str_17_bzcs_slp_spc` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_str_17_bzcs_slp_spc_00` (`slpdt`,`cls_da_seqno`,`ntacc_cd`,`dp_orgcd`,`ikd_grpcd`,`ins_imcd`,`rr_orgcd`,`slp_amt_dfrn_yn`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='IFRS17사업비전표내역';
