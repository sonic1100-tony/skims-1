--
-- Table structure for table `str_bzcs_ifrs_tacc_ldg`
--

DROP TABLE IF EXISTS `str_bzcs_ifrs_tacc_ldg`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `str_bzcs_ifrs_tacc_ldg` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='사업비IFRS총계정원장';
