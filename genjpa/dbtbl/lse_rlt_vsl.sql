--
-- Table structure for table `lse_rlt_vsl`
--

DROP TABLE IF EXISTS `lse_rlt_vsl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lse_rlt_vsl` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_lse_rlt_vsl_00` (`rcp_yymm`,`rcp_nv_seqno`,`clmps_seqno`,`clm_nv_seqno`,`rlt_vsl_seqno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='상대선박';
