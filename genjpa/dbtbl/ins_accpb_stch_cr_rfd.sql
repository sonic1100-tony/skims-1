--
-- Table structure for table `ins_accpb_stch_cr_rfd`
--

DROP TABLE IF EXISTS `ins_accpb_stch_cr_rfd`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_accpb_stch_cr_rfd` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='계리상태변경계약준비금';
