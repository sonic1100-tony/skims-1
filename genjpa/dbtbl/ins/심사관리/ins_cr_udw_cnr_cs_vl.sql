--
-- Table structure for table `ins_cr_udw_cnr_cs_vl`
--

DROP TABLE IF EXISTS `ins_cr_udw_cnr_cs_vl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_cr_udw_cnr_cs_vl` (
  ...
  PRIMARY KEY (`aid`),
  KEY `pix_ins_cr_udw_cnr_cs_vl_00` (`plno`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='자동차언더라이팅센터CS평가';
