--
-- Table structure for table `ins_nrdps_befo_ud_alarm`
--

DROP TABLE IF EXISTS `ins_nrdps_befo_ud_alarm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_nrdps_befo_ud_alarm` (
  ...
  PRIMARY KEY (`aid`),
  KEY `pix_ins_nrdps_befo_ud_alarm_00` (`nrdcd`,`ins_st`,`nw_rnw_cd`,`ins_itm_smccd`,`cr_ud_chncd`,`befo_ud_alarm_seqno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='자동차계약피보험자사전심사알람';
