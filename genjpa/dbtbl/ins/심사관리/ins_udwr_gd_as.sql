--
-- Table structure for table `ins_udwr_gd_as`
--

DROP TABLE IF EXISTS `ins_udwr_gd_as`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_udwr_gd_as` (
  ...
  `as_av_yn` varchar(1) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '배정가능여부',
  `inp_usr_id` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '입력사용자ID',
  `inp_dthms` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '입력일시',
  `mdf_usr_id` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '수정사용자ID',
  `mdf_dthms` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '수정일시',
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_udwr_gd_as_00` (`ud_stfno`,`ikd_grpcd`,`ud_bsns_flgcd`,`ud_flgcd`,`ud_gd_csfcd`,`gdcd`,`ud_rq_orgcd`)
) ENGINE=InnoDB AUTO_INCREMENT=1698 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='심사자상품배정';
