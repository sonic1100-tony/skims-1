--
-- Table structure for table `ins_rins_dcu_rcv_adr`
--

DROP TABLE IF EXISTS `ins_rins_dcu_rcv_adr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_rins_dcu_rcv_adr` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_rins_dcu_rcv_adr_00` (`rins_dcu_no`,`rcv_plac_gp_seqno`,`adr_seqno`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='재보험문서수신주소';
