--
-- Table structure for table `ins_cvr_mnamt`
--

DROP TABLE IF EXISTS `ins_cvr_mnamt`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_cvr_mnamt` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_cvr_mnamt_00` (`plyno`,`cvrcd`,`cvr_seqno`,`lb_flgcd`,`isamt_prm_flgcd`,`mncd`,`ap_nddt`,`ap_strdt`,`ndsno`)
) ENGINE=InnoDB AUTO_INCREMENT=658954 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='담보화폐금액';
