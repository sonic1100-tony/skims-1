--
-- Table structure for table `ins_cr_relpc_adr_crr`
--

DROP TABLE IF EXISTS `ins_cr_relpc_adr_crr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_cr_relpc_adr_crr` (
  ...
  `bf_bk_br_pstno` varchar(6) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '전은행지점우편번호',
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_cr_relpc_adr_crr_00` (`plyno`,`relpc_seqno`,`adr_usecd`,`ap_nddt`,`ap_strdt`,`ndsno`)
) ENGINE=InnoDB AUTO_INCREMENT=55891 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='계약관계자주소이력';
