--
-- Table structure for table `ins_cr_acsr_mch_eqamt`
--

DROP TABLE IF EXISTS `ins_cr_acsr_mch_eqamt`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_cr_acsr_mch_eqamt` (
  ...
  PRIMARY KEY (`aid`),
  KEY `pix_ins_cr_acsr_mch_eqamt_00` (`plyno`,`oj_seqno`,`acsr_mcheq_flgcd`,`acsr_mchcd`,`oldbl_seqno`,`ap_nddt`,`ap_strdt`,`ndsno`)
) ENGINE=InnoDB AUTO_INCREMENT=589 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='차량부속품기계장치가액';
