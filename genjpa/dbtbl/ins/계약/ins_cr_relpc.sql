--
-- Table structure for table `ins_cr_relpc`
--

DROP TABLE IF EXISTS `ins_cr_relpc`;
...
CREATE TABLE `ins_cr_relpc` (
  ...
  `gu_fire_lgin_id` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '구화재로그인아이디',
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_cr_relpc_00` (`plyno`,`relpc_seqno`,`ap_nddt`,`ap_strdt`,`ndsno`),
  KEY `idx_ins_cr_relpc_06` (`ctmno`,`relpc_tpcd`),
  KEY `idx_ins_cr_relpc_12` (`ctm_dscno`)
) ENGINE=InnoDB AUTO_INCREMENT=151403 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='계약관계자';
