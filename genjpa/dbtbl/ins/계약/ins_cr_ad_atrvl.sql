--
-- Table structure for table `ins_cr_ad_atrvl`
--

DROP TABLE IF EXISTS `ins_cr_ad_atrvl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_cr_ad_atrvl` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_cr_ad_atrvl_00` (`plyno`,`gpno`,`rowno`,`atrcd`,`ap_nddt`,`ap_strdt`,`ndsno`)
) ENGINE=InnoDB AUTO_INCREMENT=77978 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='계약추가속성값';
