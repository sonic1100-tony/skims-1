--
-- Table structure for table `ins_cr_sl_cvr`
--

DROP TABLE IF EXISTS `ins_cr_sl_cvr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_cr_sl_cvr` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `idx_ins_cr_sl_cvr_00` (`plyno`,`sl_cvrcd`,`sl_cvrsn`,`nds_ap_str_dthms`)
) ENGINE=InnoDB AUTO_INCREMENT=14698 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='계약판매담보';
