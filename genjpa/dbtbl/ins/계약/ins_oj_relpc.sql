--
-- Table structure for table `ins_oj_relpc`
--

DROP TABLE IF EXISTS `ins_oj_relpc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_oj_relpc` (
  ...
  `pr_bj_flgcd` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '질권대상구분코드',
  `pr_tycd` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '질권형태코드',
  `prps_dtnm` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '질권자상세명',
  `inp_usr_id` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '입력사용자ID',
  `inp_dthms` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '입력일시',
  `mdf_usr_id` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '수정사용자ID',
  `mdf_dthms` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '수정일시',
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_oj_relpc_00` (`plyno`,`relpc_seqno`,`rel_bjpcd`,`ap_nddt`,`ap_strdt`,`ndsno`,`olcrr_seqno`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='목적물관계자';
