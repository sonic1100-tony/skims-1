--
-- Table structure for table `ins_cr_nds_dt`
--

DROP TABLE IF EXISTS `ins_cr_nds_dt`;
...
CREATE TABLE `ins_cr_nds_dt` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_cr_nds_dt_00` (`plyno`,`ndsno`,`nds_dt_seqno`)
) ENGINE=InnoDB AUTO_INCREMENT=630 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='계약배서상세';
