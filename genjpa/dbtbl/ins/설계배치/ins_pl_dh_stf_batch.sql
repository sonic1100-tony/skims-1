--
-- Table structure for table `ins_pl_dh_stf_batch`
--

DROP TABLE IF EXISTS `ins_pl_dh_stf_batch`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_pl_dh_stf_batch` (
  ...
  PRIMARY KEY (`aid`),
  KEY `pix_ins_pl_dh_stf_batch_00` (`plno`,`cgaf_ch_seqno`,`dh_stf_tpcd`,`dh_stfno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='설계취급직원_배치';
