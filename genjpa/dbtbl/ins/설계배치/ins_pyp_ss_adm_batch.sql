--
-- Table structure for table `ins_pyp_ss_adm_batch`
--

DROP TABLE IF EXISTS `ins_pyp_ss_adm_batch`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_pyp_ss_adm_batch` (
  ...
  PRIMARY KEY (`aid`),
  KEY `pix_ins_pyp_ss_adm_batch_00` (`plyno`,`st_ariv_bsns_flgcd`,`pym_seq`,`ss_bj_flgcd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='시기도래관리_배치';
