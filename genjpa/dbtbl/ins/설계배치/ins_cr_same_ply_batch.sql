--
-- Table structure for table `ins_cr_same_ply_batch`
--

DROP TABLE IF EXISTS `ins_cr_same_ply_batch`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_cr_same_ply_batch` (
  ...
  PRIMARY KEY (`aid`),
  KEY `pix_ins_cr_same_ply_batch_00` (`same_ply_gpno`,`plyno_or_plno`,`cgaf_ch_seqno`,`ap_nddt`,`ap_strdt`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='자동차동일증권_배치';
