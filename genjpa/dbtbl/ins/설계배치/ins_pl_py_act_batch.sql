--
-- Table structure for table `ins_pl_py_act_batch`
--

DROP TABLE IF EXISTS `ins_pl_py_act_batch`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_pl_py_act_batch` (
  ...
  PRIMARY KEY (`aid`),
  KEY `pix_ins_pl_py_act_batch_00` (`plno`,`cgaf_ch_seqno`,`rcp_yymm`,`rcp_nv_seqno`,`relpc_or_clmps_seqno`,`py_act_flgcd`,`olcrr_seqno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='설계지급계좌_배치';
