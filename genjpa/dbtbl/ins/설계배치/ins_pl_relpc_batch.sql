--
-- Table structure for table `ins_pl_relpc_batch`
--

DROP TABLE IF EXISTS `ins_pl_relpc_batch`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_pl_relpc_batch` (
  ...
  `prm_pym_rt` decimal(12,6) NOT NULL COMMENT '보험료납부비율',
  ...
  `ut_rt` decimal(12,6) NOT NULL COMMENT '도급비율',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='설계관계자_배치';
