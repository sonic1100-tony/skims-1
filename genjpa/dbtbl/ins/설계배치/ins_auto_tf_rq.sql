--
-- Table structure for table `ins_auto_tf_rq`
--

DROP TABLE IF EXISTS `ins_auto_tf_rq`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_auto_tf_rq` (
  ...
  `fbs_cv_yn` varchar(1) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'FBS전환여부',
  ...
  `voc_no` varchar(30) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'VOC번호',
  `voc_hdcft_rgt_yn` varchar(1) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'VOC수기등록여부',
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_auto_tf_rq_00` (`plyno_or_lnno`,`auto_tf_cg_kndcd`,`ap_nddt`,`ap_strdt`,`ndsno`,`olcrr_seqno`),
  KEY `idx_ins_auto_tf_rq_10` (`actno_or_crdno`),
  KEY `idx_ins_auto_tf_rq_11` (`ctm_dscno`),
  KEY `idx_ins_auto_tf_rq_12` (`auto_tf_rqdc_ssno`),
  KEY `idx_ins_auto_tf_rq_13` (`ctmno`),
  KEY `idx_ins_auto_tf_rq_14` (`epay_peri_stm_no`)
) ENGINE=InnoDB AUTO_INCREMENT=654 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='자동이체신청';
