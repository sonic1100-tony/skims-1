--
-- Table structure for table `ins_pl_cvr_batch`
--

DROP TABLE IF EXISTS `ins_pl_cvr_batch`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_pl_cvr_batch` (
  ...
  `sb_cscd` varchar(10) COLLATE utf8mb4_bin DEFAULT '0' COMMENT '대체비용코드',
  ...
  `mpy_cv_nprm` decimal(17,2) NOT NULL DEFAULT '0.00' COMMENT '월납환산순보험료',
  `inp_usr_id` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '입력사용자ID',
  `inp_dthms` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '입력일시',
  `mdf_usr_id` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '수정사용자ID',
  `mdf_dthms` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '수정일시',
  PRIMARY KEY (`aid`),
  KEY `pix_ins_pl_cvr_batch_00` (`plno`,`cgaf_ch_seqno`,`cvrcd`,`cvr_seqno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='설계담보_배치';
