--
-- Table structure for table `ins_cr_clm_drv_info_batch`
--

DROP TABLE IF EXISTS `ins_cr_clm_drv_info_batch`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_cr_clm_drv_info_batch` (
  ...
  PRIMARY KEY (`aid`),
  KEY `pix_ins_cr_clm_drv_info_batch_00` (`relpc_tpcd`,`rsno`,`ap_strdt`,`carno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='자동차사고운전자정보_배치';
