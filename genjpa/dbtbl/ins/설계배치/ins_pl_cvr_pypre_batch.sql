--
-- Table structure for table `ins_pl_cvr_pypre_batch`
--

DROP TABLE IF EXISTS `ins_pl_cvr_pypre_batch`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_pl_cvr_pypre_batch` (
  ...
  PRIMARY KEY (`aid`),
  KEY `pix_ins_pl_cvr_pypre_batch_00` (`plno`,`cgaf_ch_seqno`,`pym_seq`,`crt_relpc_seqno`,`mncd`,`seq_db_seqno`,`cvrcd`,`cvr_seqno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='설계담보보험납입예정_배치';
