--
-- Table structure for table `ins_if_dmgrt_dt_spc_batch`
--

DROP TABLE IF EXISTS `ins_if_dmgrt_dt_spc_batch`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_if_dmgrt_dt_spc_batch` (
  ...
  PRIMARY KEY (`aid`),
  KEY `pix_ins_if_dmgrt_dt_spc_batch_00` (`plno`,`cgaf_ch_seqno`,`atrcd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='추정손해율상세내역_배치';
