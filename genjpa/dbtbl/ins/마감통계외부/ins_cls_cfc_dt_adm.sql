--
-- Table structure for table `ins_cls_cfc_dt_adm`
--

DROP TABLE IF EXISTS `ins_cls_cfc_dt_adm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_cls_cfc_dt_adm` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_cls_cfc_dt_adm_00` (`cls_yymm`,`onl_gd_yn`,`bz_avtb_csfcd`,`ikd_grpcd`,`bz_avtb_larg_ikdcd`,`bz_avtb_ikd_cvrcd`,`gdcd`,`cr_clm_cvr_flgcd`,`cvrcd`,`gn_co_appr_flgcd`)
) ENGINE=InnoDB AUTO_INCREMENT=206 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='마감계수세부관리';
