--
-- Table structure for table `ins_rlpmi_trt_bf_inq`
--

DROP TABLE IF EXISTS `ins_rlpmi_trt_bf_inq`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_rlpmi_trt_bf_inq` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_rlpmi_trt_bf_inq_00` (`mdcs_tlm_opndt`,`mdcs_tlm_admno`,`mdcs_tlm_ts_seqno`,`mdcs_cr_seqno`,`mdcs_cvr_seqno`)
) ENGINE=InnoDB AUTO_INCREMENT=1039 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='실손특약사전조회';
