--
-- Table structure for table `ins_np_cls_sts`
--

DROP TABLE IF EXISTS `ins_np_cls_sts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_np_cls_sts` (
  ...
  PRIMARY KEY (`cls_yymm`,`py_cr_tpcd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='미지급마감통계';
