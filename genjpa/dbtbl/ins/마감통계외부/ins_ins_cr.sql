--
-- Table structure for table `ins_ins_cr`
--

DROP TABLE IF EXISTS `ins_ins_cr`;
...
CREATE TABLE `ins_ins_cr` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_ins_cr_00` (`plyno`,`ap_nddt`,`ap_strdt`,`ndsno`),
  KEY `idx_ins_ins_cr_16` (`dvpns_plyno`,`ap_nddt`,`ap_strdt`,`vald_nds_yn`,`ikd_grpcd`),
  KEY `idx_ins_ins_cr_08` (`plno`),
  KEY `idx_ins_ins_cr_26` (`cnrdt`,`ikd_grpcd`,`ins_clstr`,`fnl_cr_stcd`,`ins_imcd`,`gdcd`),
  KEY `idx_ins_ins_cr_14` (`befo_plyno`),
  KEY `idx_ins_ins_cr_15` (`fnl_dh_stfno`,`ikd_grpcd`,`ap_nddt`,`ins_clstr`,`fnl_cr_stcd`,`fnl_cr_dt_stcd`,`fnl_cr_st_chdt`,`fnl_part_cvr_stcd`,`ins_imcd`,`gdcd`,`pym_mtdcd`,`plyno`),
  KEY `idx_ins_ins_cr_04` (`ppr_plyno`,`ap_nddt`,`ikd_grpcd`,`ins_clstr`,`rv_ccldt`,`vald_nds_yn`,`plyno`)
) ENGINE=InnoDB AUTO_INCREMENT=111117494 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='보험계약';
