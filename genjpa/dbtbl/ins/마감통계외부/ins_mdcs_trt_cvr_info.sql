--
-- Table structure for table `ins_mdcs_trt_cvr_info`
--

DROP TABLE IF EXISTS `ins_mdcs_trt_cvr_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_mdcs_trt_cvr_info` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_mdcs_trt_cvr_info_00` (`mdcs_tlm_opndt`,`mdcs_tlm_admno`,`mdcs_tlm_ts_seqno`,`mdcs_cr_nds_seqno`,`mdcs_cvr_seqno`)
) ENGINE=InnoDB AUTO_INCREMENT=1712 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='의료비특약담보정보';
