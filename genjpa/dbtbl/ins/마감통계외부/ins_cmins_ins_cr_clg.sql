--
-- Table structure for table `ins_cmins_ins_cr_clg`
--

DROP TABLE IF EXISTS `ins_cmins_ins_cr_clg`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_cmins_ins_cr_clg` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_cmins_ins_cr_clg_00` (`cls_yymm`,`cls_bjno`,`rn_rtro_cr_flgcd`,`rertr_flgcd`,`cls_da_flgcd`)
) ENGINE=InnoDB AUTO_INCREMENT=3541003 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='일반보험계약결산';
