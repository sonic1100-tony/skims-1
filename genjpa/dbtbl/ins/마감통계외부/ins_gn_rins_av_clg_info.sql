--
-- Table structure for table `ins_gn_rins_av_clg_info`
--

DROP TABLE IF EXISTS `ins_gn_rins_av_clg_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_gn_rins_av_clg_info` (
  ...
  `re_cn_prm` decimal(17,2) DEFAULT NULL COMMENT '출재해지보험료',
  `re_cm` decimal(17,2) DEFAULT NULL COMMENT '출재수수료',
  `woncr_re_prm` decimal(15,0) DEFAULT NULL COMMENT '원화출재보험료',
  `woncr_re_cn_prm` decimal(15,0) DEFAULT NULL COMMENT '원화출재해지보험료',
  `woncr_re_cm` decimal(15,0) DEFAULT NULL COMMENT '원화출재수수료',
  `inp_usr_id` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '입력사용자ID',
  `inp_dthms` datetime NOT NULL COMMENT '입력일시',
  PRIMARY KEY (`cls_yymm`,`rn_rtro_cr_flgcd`,`rertr_flgcd`,`cls_da_flgcd`,`plyno`,`incm_prm_cr_seqno`,`relpc_oj_seqno`,`cvrcd`,`rins_crano`,`rincd`,`mncd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='일반재보험실적결산정보'
