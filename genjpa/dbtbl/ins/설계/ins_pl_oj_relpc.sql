--
-- Table structure for table `ins_pl_oj_relpc`
--

DROP TABLE IF EXISTS `ins_pl_oj_relpc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_pl_oj_relpc` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='설계목적물관계자';
