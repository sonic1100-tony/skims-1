--
-- Table structure for table `ins_pl_isamt_dt_spc`
--

DROP TABLE IF EXISTS `ins_pl_isamt_dt_spc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_pl_isamt_dt_spc` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_pl_isamt_dt_spc_00` (`plno`,`cgaf_ch_seqno`,`cvrcd`,`cvr_seqno`,`lb_flgcd`,`isamt_prm_flgcd`,`mncd`,`isamt_flgcd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='설계가입금액상세내역';
