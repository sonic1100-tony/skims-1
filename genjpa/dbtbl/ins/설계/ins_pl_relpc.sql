--
-- Table structure for table `ins_pl_relpc`
--

DROP TABLE IF EXISTS `ins_pl_relpc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_pl_relpc` (
  ...
  KEY `idx_ins_pl_relpc_10` (`ctmno`),
  KEY `idx_ins_pl_relpc_11` (`ctm_dscno`)
) ENGINE=InnoDB AUTO_INCREMENT=132932 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='설계관계자';
