--
-- Table structure for table `ins_pl_cr_acsr_mcamt`
--

DROP TABLE IF EXISTS `ins_pl_cr_acsr_mcamt`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_pl_cr_acsr_mcamt` (
  ...
  PRIMARY KEY (`aid`),
  KEY `pix_ins_pl_cr_acsr_mcamt_00` (`plno`,`cgaf_ch_seqno`,`oj_seqno`,`acsr_mcheq_flgcd`,`acsr_mchcd`,`oldbl_seqno`)
) ENGINE=InnoDB AUTO_INCREMENT=4515 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='설계차량부속품기계장치가액';
