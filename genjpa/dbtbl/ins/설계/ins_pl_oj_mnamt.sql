--
-- Table structure for table `ins_pl_oj_mnamt`
--

DROP TABLE IF EXISTS `ins_pl_oj_mnamt`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_pl_oj_mnamt` (
  ...
  PRIMARY KEY (`plno`,`cgaf_ch_seqno`,`oj_seqno`,`isamt_prm_flgcd`,`mncd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='설계목적물화폐금액';
