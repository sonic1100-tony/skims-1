--
-- Table structure for table `ins_pl_cvr_mnamt`
--

DROP TABLE IF EXISTS `ins_pl_cvr_mnamt`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_pl_cvr_mnamt` (
  ...
  `ps1_vlamt` decimal(17,2) NOT NULL DEFAULT '0.00' COMMENT '1인당가액',
  `ps1_isamt` decimal(17,2) NOT NULL DEFAULT '0.00' COMMENT '1인당가입금액',
  ...
  `ad_prm` decimal(15,0) NOT NULL DEFAULT '0' COMMENT '가산보험료',
  `chaf_ap_prm` decimal(15,0) NOT NULL DEFAULT '0' COMMENT '변경후적용보험료',
  `chaf_woncv_apprm` decimal(15,0) NOT NULL DEFAULT '0' COMMENT '변경후원화환산적용보험료',
  `annu1_apprm` decimal(17,2) DEFAULT NULL COMMENT '1년간적용보험료',
  `woncv_annu1_apprm` decimal(15,0) DEFAULT NULL COMMENT '원화환산1년간적용보험료',
  `inp_usr_id` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '입력사용자ID',
  `inp_dthms` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '입력일시',
  `mdf_usr_id` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '수정사용자ID',
  `mdf_dthms` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '수정일시',
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_pl_cvr_mnamt_00` (`plno`,`cgaf_ch_seqno`,`cvrcd`,`cvr_seqno`,`lb_flgcd`,`isamt_prm_flgcd`,`mncd`)
) ENGINE=InnoDB AUTO_INCREMENT=519137 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='설계담보화폐금액';
