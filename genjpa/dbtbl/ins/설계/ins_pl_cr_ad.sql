--
-- Table structure for table `ins_pl_cr_ad`
--

DROP TABLE IF EXISTS `ins_pl_cr_ad`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_pl_cr_ad` (
  `plno` varchar(17) COLLATE utf8mb4_bin NOT NULL COMMENT '설계번호',
  `cgaf_ch_seqno` decimal(5,0) NOT NULL COMMENT '발행후변경순번',
  `wh_yn` varchar(1) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '원천여부',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='보험설계자동차부가';
