--
-- Table structure for table `ins_pl_relpc_adr`
--

DROP TABLE IF EXISTS `ins_pl_relpc_adr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_pl_relpc_adr` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_pl_relpc_adr_00` (`plno`,`cgaf_ch_seqno`,`relpc_seqno`,`adr_usecd`)
) ENGINE=InnoDB AUTO_INCREMENT=83316 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='설계관계자주소';
