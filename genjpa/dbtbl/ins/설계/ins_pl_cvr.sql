--
-- Table structure for table `ins_pl_cvr`
--

DROP TABLE IF EXISTS `ins_pl_cvr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_pl_cvr` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_pl_cvr_00` (`plno`,`cgaf_ch_seqno`,`cvrcd`,`cvr_seqno`)
) ENGINE=InnoDB AUTO_INCREMENT=638823 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='설계담보';
