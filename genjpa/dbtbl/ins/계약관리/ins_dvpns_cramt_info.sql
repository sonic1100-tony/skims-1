--
-- Table structure for table `ins_dvpns_cramt_info`
--

DROP TABLE IF EXISTS `ins_dvpns_cramt_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_dvpns_cramt_info` (
  ...
  PRIMARY KEY (`aid`),
  KEY `pix_ins_dvpns_cramt_info_00` (`yr`,`qtr`,`cnmcd`,`opedt`,`yytp`,`nwcr_flgcd`,`mfg_ap_str_dthms`,`mfg_ap_nd_dthms`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='개발원차량가액정보';
