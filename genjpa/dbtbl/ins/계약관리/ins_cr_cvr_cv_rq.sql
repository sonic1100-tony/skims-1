--
-- Table structure for table `ins_cr_cvr_cv_rq`
--

DROP TABLE IF EXISTS `ins_cr_cvr_cv_rq`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_cr_cvr_cv_rq` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_cr_cvr_cv_rq_00` (`plyno`,`cvrcd`,`cvr_seqno`,`ap_nddt`,`ap_strdt`,`ndsno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='계약담보전환신청';
