--
-- Table structure for table `ins_dvpns_carnm_cr_ty`
--

DROP TABLE IF EXISTS `ins_dvpns_carnm_cr_ty`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_dvpns_carnm_cr_ty` (
  ...
  PRIMARY KEY (`yr`,`qtr`,`opedt`,`cnmcd`,`ctp_usecd`,`psn_crp_flgcd`,`catcd`,`cr_tycd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='개발원차명차형태';
