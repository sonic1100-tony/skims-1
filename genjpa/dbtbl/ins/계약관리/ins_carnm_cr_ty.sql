--
-- Table structure for table `ins_carnm_cr_ty`
--

DROP TABLE IF EXISTS `ins_carnm_cr_ty`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_carnm_cr_ty` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='차명차형태';
