--
-- Table structure for table `ins_carnm_ctp`
--

DROP TABLE IF EXISTS `ins_carnm_ctp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_carnm_ctp` (
  ...
  KEY `idx_ins_carnm_ctp_02` (`yr`,`qtr`,`cnmcd`,`opedt`,`ctp_usecd`,`psn_crp_flgcd`,`catcd`),
  KEY `idx_ins_carnm_ctp_01` (`cnmcd`,`catcd`,`opedt`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='차명차종';
