--
-- Table structure for table `b2_220422_igd_ltrm_prm`
--

DROP TABLE IF EXISTS `b2_220422_igd_ltrm_prm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `b2_220422_igd_ltrm_prm` (
...
) ENGINE=InnoDB AUTO_INCREMENT=353866 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='장기보험료';
