--
-- Table structure for table `aud_rtx_cmpu_apldo_seqc`
--

DROP TABLE IF EXISTS `aud_rtx_cmpu_apldo_seqc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aud_rtx_cmpu_apldo_seqc` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='영수증전산청약서채번';
