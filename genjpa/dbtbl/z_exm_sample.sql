--
-- Table structure for table `z_exm_sample`
--

DROP TABLE IF EXISTS `z_exm_sample`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `z_exm_sample` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_z_exm_sample_name` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='z_샘플';
