--
-- Table structure for table `com_tlm_feld_ch`
--

DROP TABLE IF EXISTS `com_tlm_feld_ch`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `com_tlm_feld_ch` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_com_tlm_feld_ch_00` (`tlm_admno`,`ch_seqno`,`tlm_feld_seqno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='전문필드변경';
