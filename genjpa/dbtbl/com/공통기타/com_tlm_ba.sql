--
-- Table structure for table `com_tlm_ba`
--

DROP TABLE IF EXISTS `com_tlm_ba`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `com_tlm_ba` (
  ...
  PRIMARY KEY (`tlm_admno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='전문기본';
