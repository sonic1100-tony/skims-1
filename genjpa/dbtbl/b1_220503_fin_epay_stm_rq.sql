--
-- Table structure for table `b1_220503_fin_epay_stm_rq`
--

DROP TABLE IF EXISTS `b1_220503_fin_epay_stm_rq`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `b1_220503_fin_epay_stm_rq` (
  ...
  KEY `idx_fin_epay_stm_rq_10` (`epay_rq_sno`)
) ENGINE=InnoDB AUTO_INCREMENT=6845 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='페이결제요청';
