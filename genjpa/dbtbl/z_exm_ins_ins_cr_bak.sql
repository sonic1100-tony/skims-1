--
-- Table structure for table `z_exm_ins_ins_cr_bak`
--

DROP TABLE IF EXISTS `z_exm_ins_ins_cr_bak`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `z_exm_ins_ins_cr_bak` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_z_exm_ins_ins_cr_bak_00` (`plyno`,`ap_nddt`,`ap_strdt`,`ndsno`),
  KEY `idx_z_exm_ins_ins_cr_bak_16` (`dvpns_plyno`,`ap_nddt`,`ap_strdt`,`vald_nds_yn`,`ikd_grpcd`),
  KEY `idx_z_exm_ins_ins_cr_bak_08` (`plno`),
  KEY `idx_z_exm_ins_ins_cr_bak_26` (`cnrdt`,`ikd_grpcd`,`ins_clstr`,`fnl_cr_stcd`,`ins_imcd`,`gdcd`),
  KEY `idx_z_exm_ins_ins_cr_bak_14` (`befo_plyno`),
  KEY `idx_z_exm_ins_ins_cr_bak_15` (`fnl_dh_stfno`,`ikd_grpcd`,`ap_nddt`,`ins_clstr`,`fnl_cr_stcd`,`fnl_cr_dt_stcd`,`fnl_cr_st_chdt`,`fnl_part_cvr_stcd`,`ins_imcd`,`gdcd`,`pym_mtdcd`,`plyno`),
  KEY `idx_z_exm_ins_ins_cr_bak_04` (`ppr_plyno`,`ap_nddt`,`ikd_grpcd`,`ins_clstr`,`rv_ccldt`,`vald_nds_yn`,`plyno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='z_exm_보험계약_bak';
