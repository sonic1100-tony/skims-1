--
-- Table structure for table `b1_220323_str_cvr_bsns_av`
--

DROP TABLE IF EXISTS `b1_220323_str_cvr_bsns_av`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `b1_220323_str_cvr_bsns_av` (
  ...
  PRIMARY KEY (`st_yymm`,`orgcd`,`ins_imcd`,`sl_tpcd`,`cvrcd`)
