--
-- Table structure for table `b1_211228_ins_py_dc`
--

DROP TABLE IF EXISTS `b1_211228_ins_py_dc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `b1_211228_ins_py_dc` (
  `aid` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'AID',
  `pyno_or_py_bjno` varchar(10) COLLATE utf8mb4_bin NOT NULL COMMENT '지급번호/지급대상번호',
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_ins_py_dc_00` (`pyno_or_py_bjno`,`dc_itcd`,`dc_it_seqno`)
) ENGINE=InnoDB AUTO_INCREMENT=159 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='지급공제';
