--
-- Table structure for table `cus_nctm_agre_crr`
--

DROP TABLE IF EXISTS `cus_nctm_agre_crr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cus_nctm_agre_crr` (
  ...
  UNIQUE KEY `idx_cus_nctm_agre_crr_00` (`ctm_dscno`,`agre_csfcd`,`agre_bsnno`,`agre_utlcd`,`agre_itcd`,`ap_str_dthms`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='비고객동의이력';
