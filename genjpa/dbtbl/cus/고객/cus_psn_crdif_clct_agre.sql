--
-- Table structure for table `cus_psn_crdif_clct_agre`
--

DROP TABLE IF EXISTS `cus_psn_crdif_clct_agre`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cus_psn_crdif_clct_agre` (
  ...
  `auth_admno` bigint(20) unsigned DEFAULT NULL COMMENT '인증관리번호',
