--
-- Table structure for table `cus_en_chrct_wlst_temp`
--

DROP TABLE IF EXISTS `cus_en_chrct_wlst_temp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cus_en_chrct_wlst_temp` (
  ...
  PRIMARY KEY (`wlst_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='요주의인물WATCHLIST임시';
