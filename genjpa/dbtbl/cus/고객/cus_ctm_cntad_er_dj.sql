--
-- Table structure for table `cus_ctm_cntad_er_dj`
--

DROP TABLE IF EXISTS `cus_ctm_cntad_er_dj`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cus_ctm_cntad_er_dj` (
  ...
  `cntad_er_dl_flgcd` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '연락처오류처리구분코드',
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_cus_ctm_cntad_er_dj_00` (`ctmno`,`stfno`,`cntad_er_flgcd`,`cntad_flgcd`,`tlano`,`tltno`,`str_tlsno`,`cntad_cntrt_flgcd`,`ctm_cntdt`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='고객연락처오류대상';
