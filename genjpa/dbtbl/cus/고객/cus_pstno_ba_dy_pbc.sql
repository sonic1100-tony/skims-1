--
-- Table structure for table `cus_pstno_ba_dy_pbc`
--

DROP TABLE IF EXISTS `cus_pstno_ba_dy_pbc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cus_pstno_ba_dy_pbc` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_cus_pstno_ba_dy_pbc_00` (`rcvdt`,`sno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='우편번호기본일고시';
