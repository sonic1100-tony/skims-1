--
-- Table structure for table `cus_wlst_mch`
--

DROP TABLE IF EXISTS `cus_wlst_mch`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cus_wlst_mch` (
  ...
  PRIMARY KEY (`aid`),
  KEY `idx_cus_wlst_mch_10` (`ctm_dscno`)
) ENGINE=InnoDB AUTO_INCREMENT=766 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='WATCHLIST매치';
