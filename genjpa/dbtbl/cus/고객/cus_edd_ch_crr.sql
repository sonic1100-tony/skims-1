--
-- Table structure for table `cus_edd_ch_crr`
--

DROP TABLE IF EXISTS `cus_edd_ch_crr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cus_edd_ch_crr` (
  ...
  `mrk_psrt` decimal(7,2) NOT NULL DEFAULT '0.00' COMMENT '시장점유율',
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_cus_edd_ch_crr_00` (`edd_admno`,`ch_seqno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='EDD관리이력';
