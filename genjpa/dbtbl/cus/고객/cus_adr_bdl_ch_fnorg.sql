--
-- Table structure for table `cus_adr_bdl_ch_fnorg`
--

DROP TABLE IF EXISTS `cus_adr_bdl_ch_fnorg`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cus_adr_bdl_ch_fnorg` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='주소일괄변경금융기관';
