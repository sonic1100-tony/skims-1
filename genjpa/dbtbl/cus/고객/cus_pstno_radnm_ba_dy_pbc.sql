--
-- Table structure for table `cus_pstno_radnm_ba_dy_pbc`
--

DROP TABLE IF EXISTS `cus_pstno_radnm_ba_dy_pbc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cus_pstno_radnm_ba_dy_pbc` (
  `aid` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'AID',
  `rcvdt` date NOT NULL COMMENT '수신일자',
  `sno` varchar(7) COLLATE utf8mb4_bin NOT NULL COMMENT '일련번호',
  `pstno_id` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '우편번호ID',
  ...
  `twmd_sno` varchar(3) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '읍면동일련번호',
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_cus_pstno_radnm_ba_dy_pbc_00` (`rcvdt`,`sno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='우편번호도로명기본일고시';
