--
-- Table structure for table `gea_ga_cla_adm_adr`
--

DROP TABLE IF EXISTS `gea_ga_cla_adm_adr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gea_ga_cla_adm_adr` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='GA약관관리주소';
