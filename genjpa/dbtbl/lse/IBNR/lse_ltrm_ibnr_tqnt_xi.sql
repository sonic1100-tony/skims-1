--
-- Table structure for table `lse_ltrm_ibnr_tqnt_xi`
--

DROP TABLE IF EXISTS `lse_ltrm_ibnr_tqnt_xi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lse_ltrm_ibnr_tqnt_xi` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_lse_ltrm_ibnr_tqnt_xi_00` (`cls_yymm`,`ibnr_cvr_kndcd`,`sts_trmcd`,`cc_cyc_flgcd`,`ibnr_cls_flgcd`,`ibnr_avg_flgcd`,`wgt_rt`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='장기IBNR총량추산';
