--
-- Table structure for table `lse_cer_thmcl_dmtp_crst`
--

DROP TABLE IF EXISTS `lse_cer_thmcl_dmtp_crst`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lse_cer_thmcl_dmtp_crst` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_lse_cer_thmcl_dmtp_crst_00` (`cer_rsno`,`thme_tpcd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='모집자테마별청구유형현황';
