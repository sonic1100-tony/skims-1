--
-- Table structure for table `lse_hprm_next_mdcf`
--

DROP TABLE IF EXISTS `lse_hprm_next_mdcf`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lse_hprm_next_mdcf` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_lse_hprm_next_mdcf_00` (`rcp_yymm`,`rcp_nv_seqno`,`hprm_clm_nv_seqno`,`lb_dt_seqno`,`rmdy_hsp_flgcd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='HPRM향후치료비';
