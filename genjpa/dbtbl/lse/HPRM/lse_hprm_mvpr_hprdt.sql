--
-- Table structure for table `lse_hprm_mvpr_hprdt`
--

DROP TABLE IF EXISTS `lse_hprm_mvpr_hprdt`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lse_hprm_mvpr_hprdt` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_lse_hprm_mvpr_hprdt_00` (`rcp_yymm`,`rcp_nv_seqno`,`hprm_clm_nv_seqno`,`prprt_dt_seqno`,`seqno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='HPRM동산반제품';
