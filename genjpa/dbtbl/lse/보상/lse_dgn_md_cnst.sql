--
-- Table structure for table `lse_dgn_md_cnst`
--

DROP TABLE IF EXISTS `lse_dgn_md_cnst`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lse_dgn_md_cnst` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_lse_dgn_md_cnst_00` (`rcp_yymm`,`rcp_nv_seqno`,`clmps_seqno`,`clm_nv_seqno`,`dgncd`,`dgncd_sno`,`ud_seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='진단의료자문';
