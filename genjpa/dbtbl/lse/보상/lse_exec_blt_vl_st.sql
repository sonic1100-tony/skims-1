--
-- Table structure for table `lse_exec_blt_vl_st`
--

DROP TABLE IF EXISTS `lse_exec_blt_vl_st`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lse_exec_blt_vl_st` (
  ...
  `ntt_clm_sjtdn_amt` decimal(17,2) NOT NULL DEFAULT '0.00' COMMENT '고의사고적발금액',
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_lse_exec_blt_vl_st_00` (`rcp_yymm`,`rcp_nv_seqno`,`ctmno`,`cprt_entp_seqno`,`entp_vl_imcd`,`entp_vl_vl_itcd`,`vl_dt_itcd`,`vl_stncd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='수행능력평가기준';
