--
-- Table structure for table `lse_nsly_hsp_rtx`
--

DROP TABLE IF EXISTS `lse_nsly_hsp_rtx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lse_nsly_hsp_rtx` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='비급여입원영수증';
