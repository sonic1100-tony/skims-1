--
-- Table structure for table `lse_xi_py_mdcs_dtal`
--

DROP TABLE IF EXISTS `lse_xi_py_mdcs_dtal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lse_xi_py_mdcs_dtal` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_lse_xi_py_mdcs_dtal_00` (`rcp_yymm`,`rcp_nv_seqno`,`clmps_seqno`,`plyno`,`cc_seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='추산지급의료비세분화';
