--
-- Table structure for table `lse_next_rmdy_plst`
--

DROP TABLE IF EXISTS `lse_next_rmdy_plst`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lse_next_rmdy_plst` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_lse_next_rmdy_plst_00` (`rcp_yymm`,`rcp_nv_seqno`,`clmps_seqno`,`clm_nv_seqno`,`rmdy_hsp_flgcd`,`plst_it_seqno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='향후치료성형';
