--
-- Table structure for table `lse_nsamt`
--

DROP TABLE IF EXISTS `lse_nsamt`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lse_nsamt` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_lse_nsamt_00` (`rcp_yymm`,`rcp_nv_seqno`,`clmps_seqno`,`clm_nv_seqno`,`appr_st`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='개호비';
