--
-- Table structure for table `lse_clmnv_mvpr_fprdt`
--

DROP TABLE IF EXISTS `lse_clmnv_mvpr_fprdt`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lse_clmnv_mvpr_fprdt` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_lse_clmnv_mvpr_fprdt_00` (`rcp_yymm`,`rcp_nv_seqno`,`clmps_seqno`,`clm_nv_seqno`,`clm_nvgd_seqno`,`seqno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='사고조사동산완제품';
