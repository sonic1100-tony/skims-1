--
-- Table structure for table `lse_slr_otp_rtx`
--

DROP TABLE IF EXISTS `lse_slr_otp_rtx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lse_slr_otp_rtx` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='급여통원영수증';
