--
-- Table structure for table `fin_dtcl_ifrs_tacc_ldg`
--

DROP TABLE IF EXISTS `fin_dtcl_ifrs_tacc_ldg`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fin_dtcl_ifrs_tacc_ldg` (
  ...
  PRIMARY KEY (`stdt`,`gn_spc_flgcd`,`act_orgcd`,`ntacc_cd`,`ikd_grpcd`,`ins_imcd`,`invln_gdcd`,`fndcd`,`dltfp_flgcd`,`dltcd`,`mncd`,`tacc_tot_flgcd`,`tot_yn`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='일자별IFRS총계정원장';
