--
-- Table structure for table `fin_acct`
--

DROP TABLE IF EXISTS `fin_acct`;
...
CREATE TABLE `fin_acct` (
  ...
  `acct_use_flgcd` varchar(10) COLLATE utf8mb4_bin NOT NULL COMMENT '통장용도구분코드',
  ...
  PRIMARY KEY (`dfpcd`),
  KEY `idx_fin_acct_10` (`actno`),
  KEY `idx_fin_acct_11` (`befo_actno`),
  KEY `idx_fin_acct_12` (`bkcd`,`acct_flgcd`,`acct_stcd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='통장';
