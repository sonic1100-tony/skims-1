--
-- Table structure for table `fin_crpca_mb_tlm_crt_rcv`
--

DROP TABLE IF EXISTS `fin_crpca_mb_tlm_crt_rcv`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fin_crpca_mb_tlm_crt_rcv` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='법인카드회원전문생성수신';
