--
-- Table structure for table `fin_dtcl_cls_form`
--

DROP TABLE IF EXISTS `fin_dtcl_cls_form`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fin_dtcl_cls_form` (
  ...
  PRIMARY KEY (`stdt`,`cls_form_frmcd`,`form_seq`,`cls_form_itcd`,`act_orgcd`,`gn_spc_flgcd`,`ikd_grpcd`,`fndcd`,`lgin_id`,`dat_sourc_flgcd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='일자별마감장표';
