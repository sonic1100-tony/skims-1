--
-- Table structure for table `fin_frst_tacc_ldg`
--

DROP TABLE IF EXISTS `fin_frst_tacc_ldg`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fin_frst_tacc_ldg` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='제일총계정원장';
