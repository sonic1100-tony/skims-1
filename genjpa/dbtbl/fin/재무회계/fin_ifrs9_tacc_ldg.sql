--
-- Table structure for table `fin_ifrs9_tacc_ldg`
--

DROP TABLE IF EXISTS `fin_ifrs9_tacc_ldg`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fin_ifrs9_tacc_ldg` (
  ...
  UNIQUE KEY `pux_fin_ifrs9_tacc_ldg_00` (`st_yymm`,`gn_spc_flgcd`,`act_orgcd`,`ntacc_cd`,`ikd_grpcd`,`ins_imcd`,`invln_gdcd`,`fndcd`,`dltfp_flgcd`,`dltcd`,`mncd`,`tacc_tot_flgcd`,`tot_yn`)
) ENGINE=InnoDB AUTO_INCREMENT=136932 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='IFRS9총계정원장'
