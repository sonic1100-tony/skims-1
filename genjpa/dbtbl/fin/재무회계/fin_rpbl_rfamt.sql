--
-- Table structure for table `fin_rpbl_rfamt`
--

DROP TABLE IF EXISTS `fin_rpbl_rfamt`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fin_rpbl_rfamt` (
  ...
  `pool_pyrfd` decimal(15,0) NOT NULL DEFAULT '0' COMMENT 'POOL지급준비금액',
  `bo_pyrfd` decimal(15,0) NOT NULL DEFAULT '0' COMMENT '보세지급준비금액',
  `trt_rtro_pyrfd` decimal(15,0) NOT NULL DEFAULT '0' COMMENT '특약수재지급준비금액',
  `brd_rtro_pyrfd` decimal(15,0) NOT NULL DEFAULT '0' COMMENT '외국수재지급준비금액',
  `rn_dm_nv_rfd_cuamt` decimal(17,2) NOT NULL DEFAULT '0.00' COMMENT '원수손해조사준비금적립금액',
  `rtro_dm_nv_rfd_cuamt` decimal(17,2) NOT NULL DEFAULT '0.00' COMMENT '수재손해조사준비금적립금액',
  `re_dm_nv_rfd_cuamt` decimal(17,2) NOT NULL DEFAULT '0.00' COMMENT '출재손해조사준비금적립금액',
  `spcf_obj_nxt_nelp_rrfnd` decimal(15,0) NOT NULL DEFAULT '0' COMMENT '특정물건차기미경과책임준비금액',
  `brd_rtro_nxt_nelp_rrfnd` decimal(15,0) NOT NULL DEFAULT '0' COMMENT '외국수재차기미경과책임준비금액',
  `dmst_rtro_nxt_nelp_rrfnd` decimal(15,0) NOT NULL DEFAULT '0' COMMENT '국내수재차기미경과책임준비금액',
  `brd_re_nxt_nelp_rrfnd` decimal(15,0) NOT NULL DEFAULT '0' COMMENT '외국출재차기미경과책임준비금액',
  `dmst_re_nxt_nelp_rrfnd` decimal(15,0) NOT NULL DEFAULT '0' COMMENT '국내출재차기미경과책임준비금액',
  `nd_rtamt` decimal(15,0) NOT NULL DEFAULT '0' COMMENT '만기환급금액',
  `lap_py_rfamt` decimal(15,0) NOT NULL DEFAULT '0' COMMENT '실효지급준비금액',
