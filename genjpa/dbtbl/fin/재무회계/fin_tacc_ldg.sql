--
-- Table structure for table `fin_tacc_ldg`
--

DROP TABLE IF EXISTS `fin_tacc_ldg`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fin_tacc_ldg` (
  ...
  `dat_sourc_flgcd` varchar(10) COLLATE utf8mb4_bin NOT NULL COMMENT '데이터소스구분코드',
  ...
  UNIQUE KEY `pux_fin_tacc_ldg_00` (`st_yymm`,`gn_spc_flgcd`,`act_orgcd`,`ntacc_cd`,`ikd_grpcd`,`ins_imcd`,`invln_gdcd`,`fndcd`,`dltfp_flgcd`,`dltcd`,`mncd`,`tacc_tot_flgcd`,`tot_yn`,`dat_sourc_flgcd`)
) ENGINE=InnoDB AUTO_INCREMENT=846612 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='총계정원장'
