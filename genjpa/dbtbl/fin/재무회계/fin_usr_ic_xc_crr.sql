--
-- Table structure for table `fin_usr_ic_xc_crr`
--

DROP TABLE IF EXISTS `fin_usr_ic_xc_crr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fin_usr_ic_xc_crr` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_fin_usr_ic_xc_crr_00` (`slpdt`,`slpno`,`cr_seqno`,`ch_seqno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='사용자소득정산이력';
