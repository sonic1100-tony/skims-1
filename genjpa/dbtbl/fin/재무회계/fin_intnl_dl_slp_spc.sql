--
-- Table structure for table `fin_intnl_dl_slp_spc`
--

DROP TABLE IF EXISTS `fin_intnl_dl_slp_spc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fin_intnl_dl_slp_spc` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_fin_intnl_dl_slp_spc_00` (`slpdt`,`slpno`,`slp_lnno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='내부거래전표내역';
