--
-- Table structure for table `fin_fc_dl_list_nt_tlm`
--

DROP TABLE IF EXISTS `fin_fc_dl_list_nt_tlm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fin_fc_dl_list_nt_tlm` (
  ...
  `fc_dl_list_nt_dl_flgcd` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '외화거래명세통지거래구분코드',
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_fin_fc_dl_list_nt_tlm_00` (`upls_tlm_tsdt`,`upls_tlm_ts_hms`,`upls_tmmno`,`upls_tlmcd`,`upls_bsns_flgcd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='외화거래명세통지전문';
