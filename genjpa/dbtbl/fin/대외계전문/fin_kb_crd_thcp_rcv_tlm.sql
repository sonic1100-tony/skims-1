--
-- Table structure for table `fin_kb_crd_thcp_rcv_tlm`
--

DROP TABLE IF EXISTS `fin_kb_crd_thcp_rcv_tlm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fin_kb_crd_thcp_rcv_tlm` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_fin_kb_crd_thcp_rcv_tlm_00` (`tlm_crno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='KB카드당사수신전문';
