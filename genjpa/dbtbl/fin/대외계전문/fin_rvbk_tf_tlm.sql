--
-- Table structure for table `fin_rvbk_tf_tlm`
--

DROP TABLE IF EXISTS `fin_rvbk_tf_tlm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fin_rvbk_tf_tlm` (
  ...
  `rvbk_tf_fx_orgcd` varchar(7) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '당행이체외환기관코드',
  `rvbk_tf_fx_pyr_no` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '당행이체외환납부자번호',
  ...
  `upls_tlm_slr_flgcd` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '유플러스전문급여구분코드',
  `inp_usr_id` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '입력사용자ID',
  `inp_dthms` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '입력일시',
  `mdf_usr_id` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '수정사용자ID',
  `mdf_dthms` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '수정일시',
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_fin_rvbk_tf_tlm_00` (`upls_tlm_tsdt`,`upls_tlm_ts_hms`,`upls_tmmno`,`upls_tlmcd`,`upls_bsns_flgcd`)
) ENGINE=InnoDB AUTO_INCREMENT=1046 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='당행이체전문';
