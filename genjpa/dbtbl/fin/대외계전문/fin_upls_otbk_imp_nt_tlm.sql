--
-- Table structure for table `fin_upls_otbk_imp_nt_tlm`
--

DROP TABLE IF EXISTS `fin_upls_otbk_imp_nt_tlm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fin_upls_otbk_imp_nt_tlm` (
  ...
  `imp_nt_tsdt` date DEFAULT NULL COMMENT '불능통지전송일자',
  `imp_nt_tmmno` varchar(7) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '불능통지전문번호',
  ...
  `otbk_imp_nt_dl_flgcd` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '타행불능통지거래구분코드',
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_fin_upls_otbk_imp_nt_tlm_00` (`upls_tlm_tsdt`,`upls_tlm_ts_hms`,`upls_tmmno`,`upls_tlmcd`,`upls_bsns_flgcd`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='유플러스타행불능통지전문';
