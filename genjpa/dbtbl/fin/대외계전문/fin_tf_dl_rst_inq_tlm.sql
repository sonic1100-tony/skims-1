--
-- Table structure for table `fin_tf_dl_rst_inq_tlm`
--

DROP TABLE IF EXISTS `fin_tf_dl_rst_inq_tlm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fin_tf_dl_rst_inq_tlm` (
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_fin_tf_dl_rst_inq_tlm_00` (`upls_tlm_tsdt`,`upls_tlm_ts_hms`,`upls_tmmno`,`upls_tlmcd`,`upls_bsns_flgcd`)
) ENGINE=InnoDB AUTO_INCREMENT=187 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='이체처리결과조회전문';
