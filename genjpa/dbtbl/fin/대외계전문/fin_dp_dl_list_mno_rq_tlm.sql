--
-- Table structure for table `fin_dp_dl_list_mno_rq_tlm`
--

DROP TABLE IF EXISTS `fin_dp_dl_list_mno_rq_tlm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fin_dp_dl_list_mno_rq_tlm` (
  ...
  `dp_dl_list_mno_rq_dl_flgcd` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '예금거래명세결번요구거래구분코드',
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_fin_dp_dl_list_mno_rq_tlm_00` (`upls_tlm_tsdt`,`upls_tlm_ts_hms`,`upls_tmmno`,`upls_tlmcd`,`upls_bsns_flgcd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='예금거래명세결번요구전문';
