--
-- Table structure for table `b1_220411_igd_ltrm_prm`
--

DROP TABLE IF EXISTS `b1_220411_igd_ltrm_prm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `b1_220411_igd_ltrm_prm` (
  ...
  `bz_prm` decimal(15,0) NOT NULL COMMENT '영업보험료',
  `mdf_usr_id` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '수정사용자ID',
  `inp_dthms` datetime NOT NULL COMMENT '입력일시',
  `mdf_dthms` datetime NOT NULL COMMENT '수정일시',
  PRIMARY KEY (`aid`),
  UNIQUE KEY `idx_igd_ltrm_prm_00` (`gdcd`,`cvrcd`,`rt_key_assmb_cd`,`ap_strdt`)
) ENGINE=InnoDB AUTO_INCREMENT=353685 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='장기보험료';
