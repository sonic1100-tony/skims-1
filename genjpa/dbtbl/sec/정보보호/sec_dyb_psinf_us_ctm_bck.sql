--
-- Table structure for table `sec_dyb_psinf_us_ctm_bck`
--

DROP TABLE IF EXISTS `sec_dyb_psinf_us_ctm_bck`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sec_dyb_psinf_us_ctm_bck` (
  ...
  PRIMARY KEY (`aid`),
  KEY `pix_sec_dyb_psinf_us_ctm_bck_00` (`st_yymm`,`stdt`,`psinf_sys_flgcd`,`onl_pg_tpcd`,`stfno`,`tot_seqno`,`ctm_seqno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='일별개인정보사용고객백업';
