--
-- Table structure for table `ins_accpb_cvr_prm_diss_crr`
--

DROP TABLE IF EXISTS `ins_accpb_cvr_prm_diss_crr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ins_accpb_cvr_prm_diss_crr` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='계리담보보험료분해이력';
