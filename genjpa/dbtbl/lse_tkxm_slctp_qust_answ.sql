--
-- Table structure for table `lse_tkxm_slctp_qust_answ`
--

DROP TABLE IF EXISTS `lse_tkxm_slctp_qust_answ`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lse_tkxm_slctp_qust_answ` (
  ...
  `answ_slc_itno` decimal(5,0) NOT NULL COMMENT '답안선택항목번호',
  ...
  PRIMARY KEY (`aid`),
  UNIQUE KEY `pux_lse_tkxm_slctp_qust_answ_00` (`exm_ope_yymm`,`exm_seqno`,`exm_itm_seqno`,`tkxm_bjps_stfno`,`qust_no`,`answ_slc_itno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='응시선택형질문답안';
