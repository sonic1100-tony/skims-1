--
-- Table structure for table `b1_220411_cus_cntrt_crr`
--

DROP TABLE IF EXISTS `b1_220411_cus_cntrt_crr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `b1_220411_cus_cntrt_crr` (
  `cntrt_admno` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '접촉관리번호',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='접촉이력';
