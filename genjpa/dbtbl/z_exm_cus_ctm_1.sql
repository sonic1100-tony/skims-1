--
-- Table structure for table `z_exm_cus_ctm_1`
--

DROP TABLE IF EXISTS `z_exm_cus_ctm_1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `z_exm_cus_ctm_1` (
  ...
  PRIMARY KEY (`ctmno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='z_예제_고객_1';
