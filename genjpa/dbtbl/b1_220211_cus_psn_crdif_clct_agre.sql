--
-- Table structure for table `b1_220211_cus_psn_crdif_clct_agre`
--

DROP TABLE IF EXISTS `b1_220211_cus_psn_crdif_clct_agre`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `b1_220211_cus_psn_crdif_clct_agre` (
  ...
  `ppr_chncd` varchar(7) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '상위채널코드',
  `rcv_agre_mn_sclcd` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '수신동의수단범위코드',
  ...
  PRIMARY KEY (`agre_csf_dscno`,`ctm_flg_dscno`,`agre_csfcd`,`agre_info_utl_sclcd`,`agre_dt_it_cd`,`ap_strdt`)
