...
import com.skims.domain.entity.IgdGdJoinIgdGdCvr;
...
public interface IgdGdRepository extends JpaRepository<IgdGd, IgdGdPK>, JpaSpecificationExecutor<IgdGd> {
	...
	@Query(" select new com.skims.domain.entity.IgdGdJoinIgdGdCvr(ig.gdcd, ig.apNddt, ig.apStrdt, ig.gdSlnm, igc.cvrcd, igc.cvrPrsnm) " +
			" from IgdGd ig join IgdGdCvr igc " +
			" on ig.gdcd = igc.gdcd " +
			"		and ig.gdcd = :gdcd ")
	Optional<List<IgdGdJoinIgdGdCvr>> joinGoodsAndCoverage(@Param("gdcd") String gdcd);
}
